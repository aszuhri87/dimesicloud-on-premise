<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="#" class="app-brand-link">
        <img src="{{  asset('/dashboard/assets/svg/icons/dimensi-blue.svg') }}" alt="" height="100%" width="85%">
      </a>
    </div>
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item @if (strpos(Request::url(), 'virtual-machine')) active @endif">
        <a href="/dashboard/virtual-machine" class="menu-link">
      ...
      <li class="menu-item @if (strpos(Request::url(), 'ceph')) active @endif">
        <a href="/dashboard/ceph" class="menu-link">
      ...
      <li class="menu-item @if (strpos(Request::url(), 'management-alert')) active @endif">
        <a href="/dashboard/management-alert" class="menu-link">
      ...
      <li class="menu-item @if (strpos(Request::url(), 'object-storage')) active @endif">
        <a href="/dashboard/object-storage" class="menu-link">
